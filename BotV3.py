...
// Bot configuration
const BOT_TOKEN = "8340562614:AAF48FUGCAhhbXB5bo-su8rZ4dxl88xloPk";
...
Press Run Bot to start auto betting!`;
    ...
    async handleBigwinLogin(chatId, userId) {
        const userSession = userSessions[userId];
        userSession.step = 'login';
        userSession.platform = 'Ck';
        userSession.apiInstance = new LotteryAPI('Ck');

        const loginGuide = `Ck Big Win Login
...
Choose your betting mode:`;
    ...
    async showMyBets(chatId, userId) {
        ...
        try {
            const platform = userSession.platform || 'Ck';
            ...
            let betsText = `Your Recent Bets - Ck Big Win\n\n`;
...
Last Update: ${getMyanmarTime()}`;
    ...
    async saveUserCredentials(userId, phone, password, platform = 'Ck') {
        await this.db.run(
...
console.log("Supported Platform: Ck Big Win ONLY");
